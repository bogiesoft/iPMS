...
class CreateGanttTasksTable extends Migration
{
    ...
    public function up()
    {
		...
		DB::table('gantt_tasks')->insert(
			['id' => 30, 'text' => 'Task #2', 'start_date' => '', 'parent' => 10]);
		DB::table('gantt_tasks')->insert(
			['id' => 40, 'text' => 'Task #3', 'start_date' => '2016-08-02 00:00:00', 'duration' => 6, 'parent' => 10]);
		DB::table('gantt_tasks')->insert(
			['id' => 50, 'text' => 'Task #4', 'start_date' => '', 'parent' => 10]);
		DB::table('gantt_tasks')->insert(
		...
		DB::table('gantt_tasks')->insert(
			['id' => 140, 'text' => 'Mielstone #5', 'start_date' => '2016-08-29 00:00:00', 'type' => 'milestone', 'parent' => 10]);
    }
