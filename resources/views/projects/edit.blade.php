	...
	<div class="col-lg-7">
		<form class="form-horizontal" role="form" method="post" action="{{ route('projects.store') }}">
			...
			<div class="form-group{{ $errors->has('product') ? ' has-error' : '' }}">
				...
				<div class="col-sm-9">
					<input type="text" name="product" class="form-control" id="product" value="{{ old('product') ?: $project->product }}">
			...
			<div class="form-group{{ $errors->has('plan_start') ? ' has-error' : '' }}">
				...
				<div class="col-sm-9">
					<input type="date" name="plan_start" class="form-control" id="plan_start"  value="{{ old('plan_start') ?: $project->plan_start }}">
			...
			<div class="form-group{{ $errors->has('plan_end') ? ' has-error' : '' }}">
				...
				<div class="col-sm-9">
					<input type="date" name="plan_end" class="form-control" id="plan_end" value="{{ old('plan_end') ?: $project->plan_end }}">
			...
			<div class="form-group{{ $errors->has('start_date') ? ' has-error' : '' }}">
				...
				<div class="col-sm-9">
					<input type="date" name="start_date" class="form-control" id="start_date"  value="{{ old('start_date') ?: $project->start_date }}">
			...
			<div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }}">
				...
				<div class="col-sm-9">
					<input type="date" name="end_date" class="form-control" id="end_date" value="{{ old('end_date') ?: $project->end_date }}">
			...
			<div class="form-group{{ $errors->has('prj_group') ? ' has-error' : '' }}">
				...
				<div class="col-sm-9">
					{{ iPMS::selectProjectGroup(old('prj_group') ?: $project->prj_group) }}
			...
			<div class="form-group{{ $errors->has('level') ? ' has-error' : '' }}">
				...
				<div class="col-sm-9">
					<input type="number" name="level" class="form-control" id="level" value="{{ $project->level }}" readonly>
				</div>
			</div>
			...
			<div class="form-group{{ $errors->has('version') ? ' has-error' : '' }}">
				...
				<div class="col-sm-9">
					<input type="number" name="version" class="form-control" id="version" value="{{ $project->version+1 }}" readonly>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-9">
					<button type="submit" class="btn btn-info"><b>승인 신청</b></button>
				</div>
			</div>
