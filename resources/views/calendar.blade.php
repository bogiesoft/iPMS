...
.dhx_cal_event.event_global div,
.dhx_cal_event_line.event_global {background:red !important}
.dhx_cal_event_clear.event_global {color:red !important}
</style>
<script>
	...
	scheduler.attachEvent("onEventLoading", function(event) {
		if (event.uid == "0") event.readonly = true;
		return true;
	});
